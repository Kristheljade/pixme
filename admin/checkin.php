...
<html lang = "eng">
	<head>
		<title>Photographer/Videographer On-Going</title>
		<meta charset = "utf-8" />
...
<body>
	<nav style = "background-color:rgba(0, 0, 0, 0.1);" class = "navbar navbar-default">
		<div  class = "container-fluid">
			<div class = "navbar-header">
				<a class = "navbar-brand" >Photographer/Videographer Booking</a>
			</div>
	...
	<div class = "container-fluid">	
		<ul class = "nav nav-pills">
			...
			<li class = "active"><a href = "reserve.php">Booking</a></li>
	...
	<div class = "container-fluid">	
		<div class = "panel panel-default">
			...
			<div class = "panel-body">
				...
				<a class = "btn btn-info disabled"><span class = "badge"><?php echo $f_ci['total']?></span> On Going</a>
				...
				<table id = "table" class = "table table-bordered">
					...
					<tbody>
						<?php
							$query = $conn->query("SELECT * FROM `transaction` NATURAL JOIN `client` NATURAL JOIN `freelancer` WHERE `status` = 'On Going'") or die(mysqli_query());
						...
						<tr>
							...
							<td><center><a class = "btn btn-warning" href = "checkout_query.php?transaction_id=<?php echo $fetch['transaction_id']?>" onclick = "confirmationCheckin(); return false;"><i class = "glyphicon glyphicon-check"></i> Paid</a></center></td>
						</tr>
						<?php
							}
						?>
...
<script type = "text/javascript">
	function confirmationCheckin(anchor){
		var conf = confirm("client already paid?");
		if(conf){
