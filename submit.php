...
if (isset($_POST['review'])) {
    ...
    $data = array($name, $email, $review);
    $fp = fopen('admin/reviews.csv', 'a');
    fputcsv($fp, $data);
    fclose($fp);

    echo "_______________Thank you for your review!";
} else {
    echo "Error: Review field not found in the submitted form.";
}
?>
</body>
<style>
