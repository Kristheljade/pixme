...
<html lang = "en">
   <head>
      <title>REPORT FREELANCER FORM</title>
      <meta charset = "utf-8" />
...
<body>
   ...
   <input type="checkbox" id="menu-toggle">
    ...
    <br>
   <?php
// Check if the 'review' key exists in the $_POST array
if (isset($_POST['report'])) {
    ...
    $data = array($name, $email, $rname, $report);
    $fp = fopen('admin/reports.csv', 'a');
    fputcsv($fp, $data);
    fclose($fp);

    echo "______________________Thank you!! We will review your report!______________________";
} else {
    echo "Error: Report field not found in the submitted form.";
}
?>
