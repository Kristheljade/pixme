...
<body>
    ...
    <div class="formContainer">
        ...
        <div class="form">
            <form id="form" action="submitt.php" method="post">
                ...
                <label for="rname">Report Freelancer</label>
                <input name="rname" type="text" id="rname" placeholder="Enter your name" required/>
                <label for="report">Report:</label>
<textarea name="report" required></textarea><br><br>
