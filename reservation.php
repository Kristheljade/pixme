	...
	<div style = "margin-top: 70px;" class = "container">
		<div class = "panel panel-default">
			<div class = "panel-body">
				<strong><h3><B style = "font-size: 18px;">AVAILABLE PHOTOGRAPHER/VIDEOGRAPHER</B></h3></strong>
				<?php
					require_once 'admin/connect.php';
					$query = $conn->query("SELECT * FROM `freelancer` ORDER BY `price` ASC") or die(mysql_error());
					while($fetch = $query->fetch_array()){
				?>
					<div>
						<div style = " margin-top: 10px;">
							<img src = "photo/<?php echo $fetch['photo']?>" height = "200" width = "300"/>
						</div>
						<div style = " margin-left:20px;">
							<h3><?php echo $fetch['freelancer_type']?></h3>
							<h4><?php echo "Price: Php. ".$fetch['price'].".00"?></h4>
							
							<a style = "margin-left:50px; margin-bottom: 10px; margin-right: 10px;" href = "add_reserve.php?freelancer_id=<?php echo $fetch['freelancer_id']?>" class = "btn btn-info"><i class = "glyphicon glyphicon-list"></i> Reserve</a>

                            <a style = "margin-left:100px; margin-bottom: 10px; margin-right: 10px;" href = "gallery.php" class = "btn btn-info"><i class = "glyphicon glyphicon-list"></i> See Portfolio</a>
						</div>
					</div>
				<?php
					}
